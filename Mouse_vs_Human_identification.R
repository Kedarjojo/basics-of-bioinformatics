...
genename<-read.delim("datasets/snRNA_MAPT_Mouse_Brain/aggregate_analysis_filtered/aggregate_analysis_cortex_filtered/filtered_feature_bc_matrix/features.tsv.gz", header = FALSE, sep = "\t") 
sample<-read.delim("datasets/snRNA_MAPT_Mouse_Brain/aggregate_analysis_filtered/aggregate_analysis_cortex_filtered/filtered_feature_bc_matrix/barcodes.tsv.gz", header = FALSE, sep = "\t") 
wt_data <- readMM(file = "datasets/snRNA_MAPT_Mouse_Brain/aggregate_analysis_filtered/aggregate_analysis_cortex_filtered/filtered_feature_bc_matrix/matrix.mtx.gz") 


rownames(wt_data)<-genename$V2 
colnames(wt_data)<-sample$V1 

meta1<-read.csv("datasets/snRNA_MAPT_Mouse_Brain/custom_analysis/mouse_cortex_snrna_01/integrated/csv_for_cellranger_and_loupe/barcode_vs_cell_type_for_loupe.csv",sep = ",") 
rownames(meta1)<-meta1$barcode 
meta2<-read.csv("datasets/snRNA_MAPT_Mouse_Brain/custom_analysis/mouse_cortex_snrna_01/integrated/csv_for_cellranger_and_loupe/barcode_vs_sample_name_for_loupe.csv",sep = ",") 
...
human_matrix <- ReadMtx(mtx = "datasets_kedar/kjoshi/MAPT_Human/Cereb10_11/outs/filtered_feature_bc_matrix/matrix.mtx", 
                        cells = "datasets_kedar/kjoshi/MAPT_Human/Cereb10_11/outs/filtered_feature_bc_matrix/barcodes.tsv",                        
                        features = "datasets_kedar/kjoshi/MAPT_Human/Cereb10_11/outs/filtered_feature_bc_matrix/features.tsv") 

mouse_matrix <- ReadMtx(mtx = "datasets_kedar/kjoshi/MAPT_Mouse/Cereb10_11/outs/filtered_feature_bc_matrix/matrix.mtx", 
                        cells = "datasets_kedar/kjoshi/MAPT_Mouse/Cereb10_11/outs/filtered_feature_bc_matrix/barcodes.tsv",                        
                        features = "datasets_kedar/kjoshi/MAPT_Mouse/Cereb10_11/outs/filtered_feature_bc_matrix/features.tsv") 


human_barcodes <- read.delim("datasets_kedar/kjoshi/MAPT_Human/Cereb10_11/outs/filtered_feature_bc_matrix/barcodes.tsv", header = FALSE) 
mouse_barcodes <- read.delim("datasets_kedar/kjoshi/MAPT_Mouse/Cereb10_11/outs/filtered_feature_bc_matrix/barcodes.tsv", header = FALSE) 
